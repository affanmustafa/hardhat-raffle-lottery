...
contract Raffle is VRFConsumerBaseV2, KeeperCompatibleInterface {
    ...
    function enterRaffle() public payable {
        // require message.value > i_entranceFee
    ...
    ) public override returns (bool upkeedNeeded, bytes memory /* checkData */) {
    ...
    function getNumWords() public pure returns (uint256) {
        return NUM_WORDS; //NUM_WORDS is a constant therefore we can do pure instead of view
    }
